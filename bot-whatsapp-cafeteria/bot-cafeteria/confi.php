...
const JWT_KEY = getenv('BOT_WHATSAPP_CAFETERIA_JWT_KEY');
const API_KEY = getenv('BOT_WHATSAPP_CAFETERIA_API_KEY');
const DB_NAME = getenv('BOT_WHATSAPP_CAFETERIA_DB_NAME');
const DB_USER = getenv('BOT_WHATSAPP_CAFETERIA_DB_USER');
const DB_PASS = getenv('BOT_WHATSAPP_CAFETERIA_DB_PASSWORD');
